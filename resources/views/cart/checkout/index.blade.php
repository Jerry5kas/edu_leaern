    ...
    <div class="bg-gray-50 text-gray-800">
        ...
        <div class="max-w-7xl mx-auto p-4 sm:p-6 md:p-8 grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="bg-white shadow-md rounded-xl p-6 w-full">
                    ...
                    <div class="flex justify-between items-center">
                        <div class="flex gap-3 items-center min-w-0">
                            <img src="https://img-c.udemycdn.com/course/240x135/1708340_7108_5.jpg" alt="Course" class="w-20 h-14 rounded object-cover flex-shrink-0">
                            <p class="text-sm font-medium truncate">The Complete Flutter Development Bootcamp with Dart</p>
                        </div>
            ...
            <div class="bg-white shadow-md rounded-xl p-6 w-full self-start space-y-4">
                ...
                <!-- Proceed Button -->
                <div>
                    <button class="w-full bg-gray-800 text-white py-3 rounded-lg font-medium hover:bg-gray-700 transition-all">
                        Proceed
                    </button>
                </div>
